  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        fragments: {
          type: 'object',
          description: 'Optional root element HTML fragments keyed only by navbar, floating_actions, or footer. When navbar is present it must contain exactly one clickable data-storefront-member-auth-slot and one clickable data-storefront-cart-slot.'
        },
        css: {
          type: 'string',
