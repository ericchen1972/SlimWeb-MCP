...
'Poster create flow: when the user asks to draw or create a product poster, call slimweb_posters_create with up to five product_names, aspect_ratio defaulting to 9:16 unless the user asks for 16:9 or 1:1, and drawing_prompt containing the promotion copy and visual requirements. The tool fuzzy-searches products; if any product name has multiple matches, stop and show the returned candidates for user confirmation. Poster images are generated by Webless backend AI, stored as media assets, and returned with public_url and media_path for durable reuse.',
...
const MCP_TOOLS = [
  ...
  },
  {
    ...
    },
    {
      ...
      description: 'Create a temporary AI-generated ecommerce poster using up to five product names, the site name/logo, product names, product primary images, and the user drawing request. If any product name fuzzy search matches multiple products, stop and return candidates for user confirmation.',
      inputSchema: {
        type: 'object',
        properties: {
          site_id: { type: 'integer' },
