...
const MCP_TOOLS = [
  ...
  },
  {
    ...
    description: 'Return reference-only JSON describing the fixed navbar, floating_actions, and footer theme slots, real storefront shell data, and the current MCP-managed root CSS. Custom slot markup is user-defined and is not automatically bound to contact fields. Call before creating or modifying visual theme elements; edit root_css.current_css and pass the complete CSS back to slimweb_themes_update_root_elements.css.',
    inputSchema: {
      type: 'object',
      properties: {
        site_id: {
